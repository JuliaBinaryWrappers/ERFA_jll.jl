...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import ERFA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a00367d1-88f1-52c5-9c6b-193aa5f849e1"))
platforms = [Pkg.Artifacts.unpack_platform(e, "ERFA", artifacts_toml) for e in artifacts["ERFA"]]
...
if best_platform === nothing
    @debug("Unable to load ERFA; unsupported platform $(triplet(platform_key_abi()))")
else
